...
SQL_SERVER   = os.getenv("SQL_SERVER", "seu_servidor_sql.database.windows.net")
SQL_DATABASE = os.getenv("SQL_DATABASE", "seu_banco_de_dados")
SQL_USERNAME = os.getenv("SQL_USERNAME", "seu_usuario_sql")
SQL_PASSWORD = os.getenv("SQL_PASSWORD", "sua_senha_sql")
